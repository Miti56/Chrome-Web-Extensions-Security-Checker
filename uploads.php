...
if (isset($_POST['submit']))
{
    ...
    if($filename != '')
    {
        ...
        if (in_array($ext, $allowed))
        {
            ...
            $sql = "INSERT INTO files(filename, description ,created, manifestversion ) VALUES('$filename', '$description' ,'$created', '$versionManifest')";
            mysqli_query($con, $sql);
            header("Location: uploadView.php?st=success");

...
// fetch files
$sql = "select filename , description, manifestVersion, created from filesCRX";
...
<div class="container">
    <div class="row">
        <div class="col-xs-8 col-xs-offset-2 well">
            <form action="uploadsCRX.php" method="post" enctype="multipart/form-data">
            ...
            <table class="table table-striped table-hover">
                ...
                while($row = mysqli_fetch_array($result)) { ?>
                    <tr>
                        ...
                        <?php   $data = file_get_contents('uploadsUnzippedCRX/'.$row['filename'].'/manifest.json'); ?>
                        <td><a href="https://codebeautify.org/json-parser-online?input=<?php echo htmlentities($data); ?>" target="_blank">View Pretty</a></td>
                        <td><a href="uploadsUnzippedCRX/<?php echo $row['filename']; ?>/manifest.json" target="_blank">View </a></td>
                        <td><a href="uploadsUnzippedCRX/<?php echo $row['filename']; ?>/manifest.json" download>Download</td>
                        <td><form method="post" action="analyzeIndividual.php">
